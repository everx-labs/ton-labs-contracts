...
__interface IProposalRoot {
  ...
  [[internal, noaccept]]
  void deployProposal() = 11;

  // Allows a multi ballot to vote for proposal
  [[internal, noaccept, answer_id]]
  VotesInfo vote(uint256 pubkey, DepositType deposit, bool_t yes) = 12;
